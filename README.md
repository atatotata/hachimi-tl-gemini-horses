...
- **Slow updater or manual install?** Grab the plug-and-play [v8 release zips](https://github.com/atatotata/hachimi-tl-gemini-horses/releases/tag/text-v10) with zero re-download required.
